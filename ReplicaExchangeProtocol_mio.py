...
class ReplicaExchange:
    ...
    def run(self, n_iterations=1, save=False, save_interval:int = 1, checkpoint_simulations=False, mixing='all'):
        self.positions = []
        self.forces = []
        ...
        for iteration in range(n_iterations):
            ...
            self._mix_replicas(mixing=mixing)
